...
<html lang="en">
    ...
    <body style="background-color: #f6f7f3;">
        ...
        <div class="page-wrapper">
            <div class="nav-wrapper">
                ...
                <nav class="navbar">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item"><a href="links.php" id="active">Links</a></li>
            ...
            <h1 class="text-white">Shops & Social media</h1>
            ...
            <main class="page-content">
                <div class="card">
                    ...
                    <button class="btn"><a href="https://philo10.redbubble.com/" target="_blank">View now</a></button>
                    </div>
                </div>
                <div class="card">
                    <div class="content">
                    <h2 class="title">Teepublic</h2>
                    <button class="btn"><a href="https://www.teepublic.com/user/astore000" target="_blank">View now</a></button>
                    </div>
                </div>
                <div class="card">
                    <div class="content">
                    <h2 class="title">Linktree</h2>
                    <button class="btn"><a href="https://linktr.ee/astore000" target="_blank">View now</a></button>
                    </div>
                </div>
                <div class="card">
                    <div class="content">
                    <h2 class="title">YouTube</h2>
                    <button class="btn"><a href="https://www.youtube.com/@astore000/" target="_blank">View now</a></button>
                    </div>
                </div>
                <div class="card">
                    <div class="content">
                    <h2 class="title">Linkbio</h2>
                    <button class="btn"><a href="https://lnk.bio/astore" target="_blank">View now</a></button>
                    </div>
                </div>
                <div class="card">
                    <div class="content">
                    <h2 class="title">Facebook</h2>
                    <button class="btn"><a href="https://web.facebook.com/astore000/" target="_blank">View now</a></button>
                    </div>
                </div>
                <div class="card">
                    <div class="content">
                    <h2 class="title">Instagram</h2>
                    <button class="btn"><a href="https://www.instagram.com/astore000/" target="_blank">View now</a></button>
                    </div>
                </div>
                <div class="card">
                    <div class="content">
                    <h2 class="title">Pintrest</h2>
                    <button class="btn"><a href="https://www.pinterest.com/aasquare000/" target="_blank">View now</a></button>
                    </div>
                </div>
            </main>
