...
<html lang="en">
    ...
    <body style="background-color: #f6f7f3;">
        ...
        <div class="page-wrapper">
            <div class="nav-wrapper">
                ...
                <nav class="navbar">
                    ...
                    <ul class="nav">
                        ...
                        <li class="nav-item"><a href="artworks.php" id="active">Artworks</a></li>
            ...
            <section class="headline">
                <h1 class="text-white">Buy it now!</h1>
            ...
            <section class="arts-bloc">
                <div class="topnav">
                    <a class="active">Artworks</a>
                    <div class="topnav-right">
                        <a href="https://philo10.redbubble.com/" target="_blank">See more >></a>
                    </div>
                </div>
                
                <div class="row">
                    <div class="column">
                        <img src="assets/astronaut_cat.jpg">
                        <img src="assets/alien_earth.jpg">
                        <img src="assets/dinosaur.jpg">
                        <img src="assets/tiger.jpg">
                    </div>
                    <div class="column">
                        <img src="assets/blackmagic.jpg">
                        <img src="assets/cat.jpg">
                        <img src="assets/alien.jpg">
                        <img src="assets/keepitclean.jpg">
                    </div>
                    <div class="column">
                        <img src="assets/monalisa.jpg">
                        <img src="assets/i_choose_u.jpg">
                        <img src="assets/astronaut.jpg">
                        <img src="assets/life.jpg">
                    </div>
                    <div class="column">
                        <img src="assets/ihatevolcanoes.jpg">
                        <img src="assets/alice.jpg">
                        <img src="assets/alien1.jpg">
    ...
    <script src="js/jsExternalFile.js"></script>
    <script>
